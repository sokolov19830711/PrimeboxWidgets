...
{
    buttonStyle_ =  "QPushButton:checked{color: #ffffff; border-style:solid; border-width:0px; border-color:#00CE6E; background-color:#00b050; font-size:10pt}"
                            "QPushButton{color: #ffffff; border-style:solid; border-width:0px; border-color:#7f7f7f; background-color:#595959; font-size:10pt}";
